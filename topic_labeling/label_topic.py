...
def create_parser():
    ...
    parser.add_argument('--line_corpus_path', type=str,
                        default="./chowmein/datasets/nips-2014.dat",
...
#                      lda_random_state,
#                      lda_n_iter):
def get_topic_labels(docs,vobs,
                     n_cand_labels=100, label_min_df=5,
                     n_labels=8,
                     topic_word=None):
    """
    ...
    pmi_cal = PMICalculator(
        doc2word_vectorizer=WordCountVectorizer(vocabulary=vobs),
    ...
    return ranker.top_k_labels(topic_models=topic_word,
                               pmi_w2l=pmi_w2l,
